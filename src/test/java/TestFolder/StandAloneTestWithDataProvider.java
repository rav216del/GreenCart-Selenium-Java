...
public class StandAloneTestWithDataProvider extends BaseTest {
	...
	// @Test(dataProvider = "getData", groups = {"purchase"}, retryAnalyzer =
	// Retry.class)

	public void endToEndTestWithDataProvider(String email, String password, String ProductNames) {
